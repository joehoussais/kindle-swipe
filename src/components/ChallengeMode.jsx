    ...
    >
      ...
      <div className="relative h-full flex flex-col">
        ...
        <div className="flex items-center justify-between p-4">
          ...
          <div className="text-[#c4a882] text-sm font-medium">
            Challenge Mode
          </div>
            ...
            {phase === 'recall' && (
              ...
              >
                ...
                <div className="text-center mb-8">
                  <p className="text-[#8a8578] text-sm mb-2">From</p>
                  <h3
                  ...
                  <p className="text-[#8a8578] text-sm">{highlight.author}</p>
                </div>

                {/* Prompt */}
                <div className="text-center mb-6">
                  <p
                    className="text-[#ebe6dc] text-lg"
                ...
                {/* Input */}
                <div className="bg-[#1a1916]/80 backdrop-blur-xl rounded-2xl p-6 border border-[#3d3a36]">
                  <textarea
                    value={userResponse}
                    onChange={(e) => setUserResponse(e.target.value)}
                    placeholder="What was this about? One sentence, your words."
                    className="w-full h-32 bg-transparent text-[#ebe6dc] placeholder-[#6b5c4c] resize-none focus:outline-none text-lg"
                    style={{ fontFamily: "'Cormorant Garamond', Georgia, serif" }}
                    autoFocus
                  />

                  <div className="flex items-center justify-between mt-4 pt-4 border-t border-[#3d3a36]">
                    <p className="text-[#6b5c4c] text-xs">
                      {userResponse.length} characters
                    </p>
                    <button
                      onClick={handleSubmit}
                      disabled={!userResponse.trim() || isJudging}
                      className="px-6 py-2 rounded-lg bg-[#c4a882] hover:bg-[#d4b892] disabled:opacity-50 disabled:cursor-not-allowed transition text-[#1a1916] font-medium"
                    >
            ...
            {phase === 'result' && result && (
              ...
              >
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-[#c4a882]">{RESULT_COPY[result].subtitle}</p>
                </div>

                {/* Explanation */}
                <div className="text-center mb-6">
                  <p className="text-[#8a8578] text-sm">{explanation}</p>
                </div>

                {/* Your response */}
                <div className="bg-[#1a1916]/80 backdrop-blur-xl rounded-2xl p-5 border border-[#3d3a36] mb-4">
                  <p className="text-[#6b5c4c] text-xs uppercase tracking-wider mb-2">Your recall</p>
                  <p className="text-[#ebe6dc] text-sm">{userResponse}</p>
                </div>

                {/* Original highlight */}
                <div className="bg-white/95 rounded-2xl p-6 mb-6">
                  <p className="text-[#6b5c4c] text-xs uppercase tracking-wider mb-2">Original</p>
                  <blockquote
                  ...
                  <p className="text-[#8a8578] text-sm mt-3">— {highlight.author}</p>
                </div>
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 py-3 rounded-lg bg-[#c4a882] hover:bg-[#d4b892] transition text-[#1a1916] font-medium"
                  >
                    Continue
                  </button>
                </div>
